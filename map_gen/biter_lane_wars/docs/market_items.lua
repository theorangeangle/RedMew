...
Retailer.set_item('creeps', {
     price = creep_values["small-biter"].market_price,
     name = 'small-biter',
     name_label = 'Small Biter',
     sprite="entity/small-biter",
     description=format('+%d income. Adds 1 small biter to the enemy player team\'s creeps each wave.', creep_values["small-biter"].income)
})
...
Retailer.set_item('tomes', {
     price = 500,
     name = 'team-damage-buff',
     name_label = 'Damage Buff',
     --sprite="fix this",
     description="Increases the amount of damage done"
})
-- team bullet damage
